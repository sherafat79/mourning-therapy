...
function Hero() {
  return (
    <section className="bg-1 bg-cover bg-no-repeat flex justify-center md:items-center items-end  h-screen">
      <div className="bg-[#F8F8F8] md:bg-opacity-80 bg-opacity-100 p-11 md:w-[40rem] w-full text-black  md:backdrop-blur-[5.5px] backdrop-blur-0 animate__animated animate__zoomIn animate__faster	 ">
