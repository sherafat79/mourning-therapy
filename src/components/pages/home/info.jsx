    ...
    <AnimationOnScroll animateIn="animate__fadeInUp" duration={3}>
      <section className=" flex flex-col   text-black justify-center items-center w-8/12 mx-auto gap-16 ">
        ...
        <AnimationOnScroll animateIn="animate__zoomIn" duration={3}>
          <div className="bg-2   animate__zoomIn  bg-cover bg-no-repeat w-full rounded    ">
            <div className="w-2/5 text-bg  p-8">
              ...
              <button className="font-jakarta hover:bg-line ease-in-out duration-500 leading-7 p-1 font-semibold mt-14 text-sm rounded bg-brown flex justify-center items-center w-full">
